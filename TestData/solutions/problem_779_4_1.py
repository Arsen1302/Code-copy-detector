class Solution(object):
    def solution_779_4_1(self, transactions: List[str]) -> List[str]:
        ...
        for transaction in transactions:
            name, time, amount, city = Solution.solution_779_4_2(transaction)
    ...
    @staticmethod
    def solution_779_4_2(transaction: str) -> Tuple[str, int, int, str]:
