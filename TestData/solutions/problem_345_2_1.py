class Solution:
    def solution_345_2_1(self, trees: List[List[int]]) -> List[List[int]]:
        

        def solution_345_2_2(p1,p2,p3):
        ...
        for t in trees:
            ...
            while len(upper)>1 and solution_345_2_2(upper[-1],upper[-2],t)>0:
                upper.pop()
            
            while len(lower)>1 and solution_345_2_2(lower[-1],lower[-2],t)<0:
                lower.pop()
