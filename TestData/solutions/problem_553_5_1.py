class Solution:
    primes = [2]
    def solution_553_5_1(self, N: int) -> int:
        ...
        if digitLen % 2 == 0:
            ...
            # So first decide left side number then middle number.(right number don't matter if it's palindrome number)
                ...
                return self.solution_553_5_1(10**(digitLen+1))

    def solution_553_5_2(self, x: int) -> bool:
        notEnoughPrime = True
