class Solution:
    def solution_1032_5_1(self, s: str, k: int) -> int:
        ...
        def solution_1032_5_2(ind, res_k, carry_over=0): 
            ...
            min_len = 1 + min(len(str(cur_count)), cur_count - 1) + solution_1032_5_2(ind+1,res_k)
            ...
            for leave_count, code_count in [(0,0), (1, 1), (9, 2), (99, 3)]:
                if cur_count > leave_count and res_k >= cur_count - leave_count:
                    min_len = min(min_len, code_count + solution_1032_5_2(ind + 1,res_k - (cur_count - leave_count)))
            ...
            if next_ind > 0 and res_k >= delete_count:
                min_len = min(min_len, solution_1032_5_2(next_ind, res_k - delete_count, carry_over = cur_count))
