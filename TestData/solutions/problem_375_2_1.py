class Solution:    
    def solution_375_2_1(self, i, j, s):
    ...
    def solution_375_2_2(self, s: str) -> int:
        
        return sum(self.solution_375_2_1(i,i,s) + self.solution_375_2_1(i,i+1,s) for i in range(len(s)))