class Solution:
    ...
    def solution_274_1_1(self, max_heap, min_heap, heap_size):
        if heap_size % 2 == 1:
            return -max_heap[0]
        else:
            return (-max_heap[0] + min_heap[0]) / 2

    def solution_274_1_2(self, nums: List[int], k: int) -> List[float]:
        max_heap = []
        min_heap = []
        ...
        median = self.solution_274_1_1(max_heap, min_heap, k)
