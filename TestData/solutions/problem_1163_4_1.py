    ...
    def solution_1163_4_1(self, n: int) -> List[int]:
        ...
        def solution_1163_4_2(i, seen):
            ...
            if self.arr[i] != -1: #move to next index if current one is taken
                return solution_1163_4_2(i+1, seen)
            ...
            for idx in range(n, 0, -1):
                ...
                ans = solution_1163_4_2(i+1, seen)
