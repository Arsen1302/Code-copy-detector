class Solution:
    def solution_1032_3_1(self, s: str, k: int) -> int:
        # We define solution_1032_3_2(i, curr_run_ch, run_length, nb_dels_remain) to return 
        ...
        memo = {}
        def solution_1032_3_2(i, curr_run_ch, run_length, nb_dels_remain):
            if i == len(s):
                return 0
            ...
            if nb_dels_remain > 0:
                ...
                del_ch_cost = solution_1032_3_2(i + 1, curr_run_ch, run_length, nb_dels_remain - 1)
            ...
            if s[i] == curr_run_ch:
                ...
                if run_length == 1 or len(str(run_length + 1)) > len(str(run_length)):
                    extra_digit_cost = 1
                keep_ch_cost = extra_digit_cost + solution_1032_3_2(i + 1, curr_run_ch, run_length + 1, nb_dels_remain)
            else:
                ...
                keep_ch_cost = 1 + solution_1032_3_2(i + 1, s[i], 1, nb_dels_remain)
            
            memo[key] = min(keep_ch_cost, del_ch_cost)
            return memo[key]
        
        return solution_1032_3_2(0, '', 0, k)