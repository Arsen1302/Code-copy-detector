class Solution:
    def solution_1077_1_1(self, s: str) -> int:
        ans, n = 0, len(s)
        def solution_1077_1_2(i, cnt, visited):
            nonlocal ans, n
            ...
            for j in range(i+1, n+1):    
                ...
                solution_1077_1_2(j, cnt+1, visited)              # backtracking
                visited.remove(s[i:j])              # recover visited set for next possibility
        solution_1077_1_2(0, 0, set())                            # function call
        return ans