class Solution:
    def solution_1379_5_1(self, board: List[List[str]], word: str) -> bool:
        nrows = len(board)
        ncols = len(board[0])
        wlen = len(word)
        ...
        def solution_1379_5_2(blocks, word):
            candidates = blocks
        ...
        return solution_1379_5_2(blocks, word) or solution_1379_5_2(blocks, word[::-1])