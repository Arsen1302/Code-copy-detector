class Solution:
    def solution_1206_5_1(self, baseCosts: List[int], toppingCosts: List[int], target: int) -> int:
        ...
        @lru_cache(None)
        def solution_1206_5_2(toppingIdx, used):
            # base case
            if used > target:
                # update if closer
            ...
            # move onto next
            # pick current item
            solution_1206_5_2(toppingIdx+1, used+toppings[toppingIdx])
            # skip current item
            solution_1206_5_2(toppingIdx+1, used)

        # try out different base
        for base in baseCosts:
            solution_1206_5_2(0, base)
