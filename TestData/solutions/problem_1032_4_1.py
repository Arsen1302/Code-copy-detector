class Solution:
    def solution_1032_4_1(self, s: str, k: int) -> int:

        def solution_1032_4_2(l0, k):
            if k>=l0:
                return 0, {(0, "", 0)}
            if not k:
                ct=1
        ...
        if l0<50:
            for i in range(1, l0+1):
                table=[solution_1032_4_2(i, j) for j in range(k+1)]
        else:
            for i in range(1, l0+1):
                table=[solution_1032_4_3(i, j) for j in range(k+1)]
