class Solution:
    def solution_484_2_1(self, board: List[str]) -> bool:
        n = 3
        rows = [0] * n
        cols = [0] * n
        diag = antidiag = balance = 0
        
        def solution_484_2_2(v):
        ...
        if balance == 0 and solution_484_2_2(n): return False
        if balance == 1 and solution_484_2_2(-n): return False
