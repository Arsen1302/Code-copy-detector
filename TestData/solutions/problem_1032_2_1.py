class Solution:
    def solution_1032_2_1(self, s: str, k: int) -> int:
        #traverse the string
        ...
        memo = {}
        return self.solution_1032_2_2(s, 0, k, None, 0, memo)
    
    def solution_1032_2_2(self, s, i, k, prev, l, memo):
        if i == len(s):
            return 0
        ...
        if k > 0:
            delete = self.solution_1032_2_2(s, i + 1, k - 1, prev, l, memo)
        else:
        ...
        if s[i] == prev:
            ...
            skip = carry + self.solution_1032_2_2(s, i + 1, k, s[i], l + 1, memo)
        else:
            skip = 1 + self.solution_1032_2_2(s, i + 1, k, s[i], 1, memo)
