class Solution:
    def solution_1504_1_1(self, time: List[int], totalTrips: int) -> int:
        ...
        def solution_1504_1_2(expected_time: int) -> int:
            nonlocal ans
            count = 0
            for i in time:
        ...
        while l < r-1: # Till Binary Search can continue. 
            ...
            status = solution_1504_1_2(mid) # The return values 1/-1 in solution_1504_1_2 function determines which pointer to move.
            if status == 1:
                l = mid
            else:
                r = mid
