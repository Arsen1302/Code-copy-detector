class Solution:
    def solution_1401_1_1(self, parents: List[int]) -> int:
        ...
        solution_1401_1_2(0)                           # starting from root (0)
