class Solution:
    def solution_1188_1_1(self, events: List[List[int]], k: int) -> int:
        ...
        @lru_cache(None)
        def solution_1188_1_2(end: int, event_index: int, k: int):
            ...
            if event_start <= end:
                ...
                return solution_1188_1_2(end, event_index + 1, k)
            ...
            attend = event_value + solution_1188_1_2(event_end, event_index + 1, k - 1)
            skip = solution_1188_1_2(end, event_index + 1, k)
            
            # Get the best option
            return max(attend, skip)
            
        # Clear cache to save memory
        solution_1188_1_2.cache_clear()
        return solution_1188_1_2(0, 0, k)