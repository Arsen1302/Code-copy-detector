class Solution:
    def solution_25_3(self, root: Optional[TreeNode], targetSum: int) -> bool:
	    ...
	    return self.solution_25_3(root.left, targetSum - root.val) or self.solution_25_3(root.right, targetSum - root.val)