class Solution:
    def solution_661_2_1(self, grid: List[List[int]]) -> int:
        ...
        def solution_661_2_2(i: int, j: int) -> int:
            """
            ...
            for x, y in ((i-1, j), (i+1, j), (i, j-1), (i, j+1)):
                ...
                if 0 <= x < m and 0 <= y < n:
                    if grid[x][y] == 0:
                        ...
                        grid[x][y] = -1
                        count -= 1
                        result += solution_661_2_2(x, y)
                        # solution_661_2_2 and reset
                        grid[x][y] = 0
                        count += 1
                    elif grid[x][y] == 2:
        ...
        return solution_661_2_2(start[0], start[1])