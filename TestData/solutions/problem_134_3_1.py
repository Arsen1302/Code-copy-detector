class Solution:
    def solution_134_3_1(self, num: int) -> str:
        ...
        def solution_134_3_2(n):
            """Return English words of n (0-999) in array."""
            if not n: return []
            elif n < 20: return [mp[n]]
            elif n < 100: return [mp[n//10*10]] + solution_134_3_2(n%10)
            else: return [mp[n//100], "Hundred"] + solution_134_3_2(n%100)
        
        ans = []
        for i, unit in zip((9, 6, 3, 0), ("Billion", "Million", "Thousand", "")): 
            n, num = divmod(num, 10**i)
            ans.extend(solution_134_3_2(n))
