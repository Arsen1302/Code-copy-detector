class Solution:
    def solution_661_1_1(self, grid: List[List[int]]) -> int:
        ...
        def solution_661_1_2(x, y, visit):
            if (x, y) == end:
            ...
            if (x-1, y) in visit:
                ...
                result += solution_661_1_2(x-1, y, visit)  # then, DFS to find all valid paths from that coordinate
        ...
        return solution_661_1_2(start[0], start[1], visit)  # we start from the starting point, solution_661_1_2 all the way back, and consolidate the result