class Solution:
    def solution_1215_3_1(self, n: int, edges: List[List[int]]) -> int:
        ...
        ans, mod = 0, int(1e9+7)
        @cache
        def solution_1215_3_2(node):                              # use DFS to find total number of paths
            if node == n:
                return 1
            cur = 0 
            for nei in graph[node]:
                cur = (cur + solution_1215_3_2(nei)) % mod
            return cur    
        return solution_1215_3_2(1)