class Solution:
def solution_1155_2_1(self, grid: List[List[int]]) -> List[int]:
m,n = len(grid),len(grid[0])
def solution_1155_2_2(row,col):
...
return solution_1155_2_2(row+1,new_col)
res = []
for i in range(n):
res.append(solution_1155_2_2(0,i))
return res